...
```{r}
covariates1 <- c("SUCO", "BTN3A1", "TBC1D2", "GZMB", "C1QA", "C1QB", "LINC02908", "MIR3667HG", "CCL4", "CXCL10", "CCL5")
...
```{r}
covariates2 <- c("KLRD1", "GBP4", "OCA2", "CTNNA2", "POU4F1", "NECAB2", "CCL8", "NCCRP1", "PYHIN1", "FGF2", "PLAAT4", "PATL2", "GBP1", "GBP1P1")
...
```{r}
survplotdata <- RNA_meta[,c("OS_MONTHS", "OS_STATUS", "SUCO", "BTN3A1", "TBC1D2", "GZMB", "C1QA", "C1QB", "LINC02908", "MIR3667HG", "CCL4", "CXCL10", "CCL5", "KLRD1", "GBP4", "OCA2", "CTNNA2", "POU4F1", "NECAB2", "CCL8", "NCCRP1", "PYHIN1", "FGF2", "PLAAT4", "PATL2", "GBP1", "GBP1P1")] 
head(survplotdata)
```
2.4.1 articles
...
```{r}
Expr <- 1
for (x in c("KLRD1", "GBP4", "OCA2", "CTNNA2", "POU4F1", "NECAB2", "CCL8", "NCCRP1", "PYHIN1", "FGF2", "PLAAT4", "PATL2", "GBP1", "GBP1P1"))
{
  survplotdata[[x]] <- ifelse(survplotdata[[x]] >= Expr, 'High', 'Low')
  survplotdata[[x]] <- factor(survplotdata[[x]],
    levels = c('Low', 'High'))
