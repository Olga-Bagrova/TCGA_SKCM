---
title: "TCGA_SKCM_Report_DZ_descriptive"
...
par.p <- c("PATIENT_ID", "SEX", "AJCC_PATHOLOGIC_TUMOR_STAGE", "AGE", "WEIGHT", "PERSON_NEOPLASM_CANCER_STATUS")
...
df.num <-
  ...
  mutate(Parameter = factor(Parameter, levels = c("AGE", "WEIGHT", "ANEUPLOIDY_SCORE", "TMB_NONSYNONYMOUS", "log10TMB")))
...
df.meta %>%
  ...
  select(-PATIENT_ID, -SAMPLE_ID, -TISSUE_SOURCE_SITE) %>%
  tbl_summary()
```
